      ...
      <TABLE cellSpacing=0 cellPadding=0 width=758 border=0>              
        ...
        <TR>              
          <TD align=center valign=middle>              
              ...
              <table width="780" border="0" cellpadding=4 cellspacing="4" height="360">             
                <tr>             
                  <td height="353" valign="top">             
                    <table width="90%" border="0" cellspacing="0" cellpadding="0">             
                      <tr>              
                        <td height="28" width="80%">Newsletter to Members</td>
                        <td>Date</td>            
                      </tr>             
                      <tr>              
                        <td>              
                    ...
                    if subflage then             
					  ...
					  %>             
                            ...
                            <tr bgcolor=<%=submycolor%>>             
							  ...
							  &nbsp;&nbsp;&nbsp;&nbsp;<span onclick="javascript:window.open('<%=subrs("http")%>','user','toolbar=no,location=no,directories=no,status=no,menubar=no,scrollbars=yes,resizable=yes,top=80,left=160,width=800,height=600');" style="cursor:hand"><included src="included/row.gif" width="10" height="8">&nbsp;&nbsp;<%=replace(trim(server.htmlencode(subrs("title"))),vbcrlf,"<br>")%></span>             
                              </td>
