...
<%	strsql="Select * from Acclist where A_id= "& session("carno") &" ORDER BY Acclist.id DESC  "	
	...
	if not Acres.eof then 
          ...
          <table width="600" cellspacing="0" cellpadding="0" border="1">
            <tr align="center" bgcolor="#003366" > 
              <td colspan="7" height="40"> 
                <p><font color="#FFFFFF" size="3" face="Arial, Helvetica, sans-serif"><b><font size="2">定购单</font></b></font></p>
              </td>
            </tr>
            <tr align="center" bgcolor="#003366"> 
              <td width="153" align="center" height="31"><font size="2" color="#FFFFcc">型号: </font></td>
              <td width="154" align="center" height="31"><font size="2" color="#FFFFcc">数量</font></td>
              <td width="131" align="center" height="31"><font  size="2" color="#FFFFcc">价格:</font></td>
              <td width="152" align="center" height="31"><font size="2" color="#FFFFcc">总额</font></td>
            </tr>
            <%  set acres=nothing 
				  	adopenkeyset=3
					adlockoptimistic=2
		...
		%>
			...
			%>
<tr align="center" bgcolor="#003366" > 
              <td height="29"><font size="2" color="#FFFFcc"><b>公司名称: </b></font></td>
              <td height="14"> 
                <div align="left"> 
...
<tr align="center" bgcolor="#003366" > 
              <td height="29"><font size="2" color="#FFFFcc"><b>姓: </b></font></td>
              <td height="14"> 
                <div align="left"> 
...
<tr align="center" bgcolor="#003366" > 
              <td height="29"><font size="2" color="#FFFFcc"><b>名: </b></font></td>
              <td height="14"> 
                <div align="left"> 
...
<tr align="center" bgcolor="#003366" > 
              <td height="29"><font size="2" color="#FFFFcc"><b>电邮: </b></font></td>
              <td height="14"> 
                <div align="left"> 
            ...
            <tr align="center" bgcolor="#003366" > 
              <td rowspan="3" height="29"><font size="2" color="#FFFFcc"><b>送货地址</b></font></td>
            ...
            <tr align="center" bgcolor="#003366" > 
              <td height="7" colspan="7"><font color="#000099"> 
                ...
                <input type="button" name="Button2" value="付款" onClick="dofin();">
                <input type="button" value="更新"  name="button2" onClick="dofresh();">
                <input type="button" name="Button" value="清空购物篮" onClick="dodelect();">
                </font></td>
            </tr>
          </table>
          <%else%>
