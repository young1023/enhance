...
<table border="0" cellspacing="0" cellpadding="0" width="99%" height="455">
  <tr align="center"> 
  ...
  <tr> 
    ...
    <td height="103" width="694" valign="top"> 
          ...
          <tr> 
            ...
            <td width="307">
              <select name="selstate" size="1">
                <option <% If ct="" then %> selected <% End If %> value="" >Select Country-----------------------</option>
				<%
          ...
          <tr> 
            ...
            <td width="307"> 
              <select size="1" name="selsize">
                <option <% If cs="" then %>selected<% End If %> value="" >Select Company Size ----------------</option>
				<%
          ...
          <tr> 
            ...
            <td width="307"> 
              <select size="1" name="seltype">
                <option <% If bt="" then %>selected <% End If %> value="" >Select Business Type-----------------</option>
				<%
