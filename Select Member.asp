...
function showpageno(pageno)
	if recount>10 then
		...
		if pageno>10 then
		     response.write "<a href='select member.asp?pageno=1&strorder="&strorderpage&"'> The First Page</a>&nbsp;&nbsp;"
			response.write "<a href='select member.asp?pageno="&(pageno-9-(pageno  mod 10) )&"&strorder="&strorderpage&"'>Previous 10</a>&nbsp;&nbsp;"
		end if
		strtemp=pageno
	 ...
	 for i=(strtemp-(strtemp mod 10)+1) to (strtemp+10-(strtemp mod 10))
            ...
            if i- pageno=0 then
				...
				response.write "<a href='select member.asp?Pageno="&i&"&strorder="&strorderpage&"'>  "&cstr(i)&" </a>&nbsp;&nbsp;"
			end if	
		next
		if (pageno\10)<(lastpage\10) then
		        response.write "<a href='select member.asp?Pageno="&(pageno+11-(pageno mod 10)) &"&strorder="&strorderpage&"'>Next 10</a>&nbsp;&nbsp;"
			   response.write "<a href='select member.asp?Pageno="& (lastpage) &"&strorder="&strorderpage&"'> The Last Page</a>&nbsp;&nbsp;"
		end if
