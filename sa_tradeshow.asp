  ...
  <TABLE border=0 cellPadding=0 cellSpacing=0 height=100% width=99%>  
    ...
    <TR>  
      <TD vAlign=top>  
                  ...
                  <td valign="top" align="center" bgcolor="#E6EBEF">  
                    <table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#E6EBEF">  
                     <tr>   
                        ...
                        <td height="48" align="center"><font color="#FF0000" size="2">Trade Show
                          Management</font></td>  
                        </tr>  
                        <tr>   
		...
		if findnum="" then  
          fsql="select * from tradeshow order by trade_id desc"  
		else  
          fsql="select * from tradeshow where trade_name like '%"&findnum&"%' order by typeid desc"  
		end if  
                              ...
                              <tr>   
                                <td valign="top" height="28">   
                                  <table width="100%" border="0" align=center cellpadding="1" cellspacing="1">  
                                    <tr>   
<td width="10%" bgcolor="#006699" height="23"><font color="#FF0000" size="2">Trade ID</font></td>   
                                      <td bgcolor="#006699" height="23"><font color="#FF0000" size="2">Trade Name</font></td>
<td width="20%" align="center" bgcolor="#006699"><font color="#FF0000" size="2">Location</font></td> 
<td width="20%" align="center" bgcolor="#006699"><font color="#FF0000" size="2">Hyperlink</font></td>    
                                      <td width="10%" align="center" bgcolor="#006699"><font color="#FF0000" size="2">Trade Date</font></td>  
 ...
 if frs.recordcount>0 then  
  ...
  do while (frs.PageSize-i)  
   ...
   response.write "<td align=center>"&(frs("trade_id"))&"</td>"  
   response.write "<td onmouseover=javascript:style.background='#cccccc' onmouseout=javascript:style.background='"&mycolor&"'>"  
   %>  
                                    <%=frs("trade_name")%> 
                                    <%  
   response.write "</td>" 
   response.write "<td align=center>"&(frs("location"))&"</td>" 
   %> 
   <td align=center><a href="<%=frs("http")%>" target="_blank"><%=frs("http")%></a></td> 
   <%
   response.write "<td align=center>"&(frs("trade_date"))&"</td>"  
   response.write "<td align=center><a href='sa_m_tradeshow.asp?id="&frs("id")&"'>Modify</a>"  
   response.write "</td>"  
...
document.ok.action="sa_tradeshow.asp"  
document.ok.submit();  
}  
...
%>  
                              ...
                              <tr>   
                                <td height="28" align="center">   
                                  ...
                                  <%  
if frs.recordcount>0 then  
  response.write "<input type='button' value='Delete Record' onClick='delcheck();' style='BACKGROUND-COLOR: #f8f8f8; BORDER-BOTTOM: #9a9999 1px solid; BORDER-LEFT: #9a9999 1px solid; BORDER-RIGHT: #9a9999 1px solid; BORDER-TOP: #9a9999 1px solid; FONT-SIZE: 9pt; HEIGHT: 20px; WIDTH:160px'>"  
  response.write "<input type=hidden value='delshow' name=whatdo>"  
...
function dosubmit(){  
 ...
 if (document.addm.title.value == "")  
  {  
   alert("Please input the name of the trade show.");  
   document.addm.trade_name.focus();  
   return false;  
  }  
 if (document.addm.trade_date.value == "")  
  {  
   alert("Please input the date of the trade show.");  
   document.addm.content.focus();  
   return false;  
  }  
...
<form name=addm method=post>  
				            <table width="93%" border="0" cellspacing="0" cellpadding="0">  
                              <tr>  
                          <td>  
                                  <div id="m" style="color:blue;cursor:hand" onclick="document.all.c.style.display= (document.all.c.style.display =='none')?'':'none'" ><font color="#FF0000" size="2">●&nbsp;&nbsp;Add Tradeshow    
                                    </font></div>    
              <div id="c" style="display:none" align=center>    
                                    <table width="100%" border="1" cellpadding="1" cellspacing="1">
<tr>     
                                        <td width="18%" height="23" align="right"><font color="#FF0000" size="2">TradeShow ID    
                                          :</font> </td>    
                                        <td>     
                                          <font color="#FF0000" size="2">    
                                          <input type="text" name="trade_id" size="3" style="BACKGROUND-COLOR: #f8f8f8; BORDER-BOTTOM: #9a9999 1px solid; BORDER-LEFT: #9a9999 1px solid; BORDER-RIGHT: #9a9999 1px solid; BORDER-TOP: #9a9999 1px solid; FONT-SIZE: 10pt" value="" maxlength="3"></font></td></tr>
...
Try to use 10, 20, 30 as the News ID. If you want to insert a News, use the number from 11 to 19 between 10 and 20.
                                      ...
                                      <tr>     
                                        <td width="18%" height="23" align="right"><font color="#FF0000" size="2">Tradeshow Name    
                                          :</font> </td>    
                                        <td>     
                                          <font color="#FF0000" size="2">    
                                          <input type="text" name="trade_name" size="60" style="BACKGROUND-COLOR: #f8f8f8; BORDER-BOTTOM: #9a9999 1px solid; BORDER-LEFT: #9a9999 1px solid; BORDER-RIGHT: #9a9999 1px solid; BORDER-TOP: #9a9999 1px solid; FONT-SIZE: 10pt" value="" maxlength="60">   
                                          </font>   
                                        </td>   
                                      </tr>   
<tr>     
                                        <td width="18%" height="23" align="right"><font color="#FF0000" size="2">Location    
                                          :</font> </td>    
                                        <td>     
                                          <font color="#FF0000" size="2">    
                                          <input type="text" name="trade_location" size="60" style="BACKGROUND-COLOR: #f8f8f8; BORDER-BOTTOM: #9a9999 1px solid; BORDER-LEFT: #9a9999 1px solid; BORDER-RIGHT: #9a9999 1px solid; BORDER-TOP: #9a9999 1px solid; FONT-SIZE: 10pt" value="" maxlength="60">   
                                          </font>   
                                        </td>   
                                      </tr>   
                                      <tr>    
                                        <td width="18%" height="23" align="right"><font color="#FF0000" size="2">Hyperlink<br>
Full hyperlink <br>
e.g. http://www.yahoo.com
                                          :</font> </td>    
                                        <td>     
                                          <font color="#FF0000" size="2">    
                                         <input type="text" name="trade_link" size="60" style="BACKGROUND-COLOR: #f8f8f8; BORDER-BOTTOM: #9a9999 1px solid; BORDER-LEFT: #9a9999 1px solid; BORDER-RIGHT: #9a9999 1px solid; BORDER-TOP: #9a9999 1px solid; FONT-SIZE: 10pt" value="" maxlength="60">   
                                          </font>   
                                        </td>   
                                      </tr>   
                                     <tr>    
                                        ...
                                        <td>     
                                          <font color="#FF0000" size="2">    
                                         <input type="test" name="trade_date" size="30" style="BACKGROUND-COLOR: #f8f8f8; BORDER-BOTTOM: #9a9999 1px solid; BORDER-LEFT: #9a9999 1px solid; BORDER-RIGHT: #9a9999 1px solid; BORDER-TOP: #9a9999 1px solid; FONT-SIZE: 10pt" value="" maxlength="30">   
                                          </font>   
                                        </td>   
                                      </tr>   
                                      <tr>    
                                        <td colspan="2" align="center">    
                                          ...
                                          <input type=hidden name=whatdo value='addshow'>    
                                          </font>    
                                        </td>    
                                      </tr>    
                                    </table>    
