 ...
 if frs.recordcount>0 then  
  ...
  do while (frs.PageSize-i)  
   ...
   %>  
                                    ...
                                    <%  
   response.write "</td>"  
   response.write "<td align=center>"&(frs("http"))&"</td>"  
...
<tr>     
                                        ...
                                        <td>     
                                          <font color="#FF0000" size="2">    
                                          <input type="text" name="title" size="23" style="BACKGROUND-COLOR: #f8f8f8; BORDER-BOTTOM: #9a9999 1px solid; BORDER-LEFT: #9a9999 1px solid; BORDER-RIGHT: #9a9999 1px solid; BORDER-TOP: #9a9999 1px solid; FONT-SIZE: 10pt" value="" maxlength="30">   
                                          </font>   
                                        </td>   
                                      </tr>   
