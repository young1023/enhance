    ...
    <tr> 
      <td width="790"> 
		...
		'	response.write recount
				...
				<% if recount=1 then%>           
				  <br><font size="1"> 
           There is <%=recount%> record found.</font> 
            <%else%>		                   
				<br><font size="1">There are <%=recount%> records found.</font> 
		   ...
		   <form name="form1" action="enquiry.asp" method="post">
            <table width="98%" border="0" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF">
              ...
              <tr> 
				  ...
				  %>
                       <a href="snew.asp?action_button=<%= server.URLencode(straction) %>&strwhere=<%= server.URLencode(strwhere) %>&pageno=<%= 1 %>"> 
...
<% end if 
            ...
            <p>
            <div align=center>
            There is no new product at the moment.
            </div>
            </p>
            <% End If %>                                     
            <% End If %>                                       
...
function showpageno(pageno,straction,strwhere) 
	if recount>9 then 
		...
		if pageno>9 then 
		     response.write "<a href='snew.asp?action_button="&server.URlencode(straction)&"&strwhere="& server.URLencode(strwhere)&"&pageno=1'> The First Page</a>&nbsp;&nbsp;" 
			response.write "<a href='snew.asp?action_button="&server.URlencode(straction)&"&strwhere="& server.URLencode(strwhere)&"&pageno="&(pageno-9-(pageno  mod 9) )&"'>Previous </a>&nbsp;&nbsp;" 
		end if 
		strtemp=pageno 
	 ...
	 for i=(strtemp-(strtemp mod 9)+1) to (strtemp+9-(strtemp mod 9)) 
            ...
            if i- pageno=0 then 
				...
				response.write "<a href='snew.asp?action_button="&server.URlencode(straction)&"&strwhere="& server.URLencode(strwhere)&"&Pageno="&i&"'>  "&cstr(i)&" </a>&nbsp;&nbsp;" 
			end if	 
		next 
		if (pageno\9)<(lastpage\9) then 
		       	response.write "<a href='snew.asp?action_button="&server.URlencode(straction)&"&strwhere="& server.URLencode(strwhere)&"&Pageno="&(pageno+11-(pageno mod 9)) &"'>Next</a>&nbsp;&nbsp;" 
			   response.write "<a href='snew.asp?action_button="&server.URlencode(straction)&"&strwhere="& server.URLencode(strwhere)&"&Pageno="& (lastpage) &"'> The Last Page</a>&nbsp;&nbsp;" 
		end if 
