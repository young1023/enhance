...
function seachmodel()
{
document.editproduct.action="sa_whatnew.asp";
document.editproduct.submit();
}
    ...
    <td width="644" valign="top">  
     <b><a href="DatAdmin.asp"><center><font face="Arial, Helvetica, sans-serif" size="2" color="#FF0000">Back to 
      ...
      <div align="center"><b>  
        ...
        <form name="editproduct" action="sa_whatnew.asp" method="post">  
              <center>
            <font color="#FF0000">
            <input type="text" name="pname" maxlength="30" size="18" value="<%=pname%>">
            <input type="button" value="Find Model" onclick="seachmodel();"> 
            <input type="submit" name="Submit2" value=" Select/ unselect product to What's New "></font></center> 
...
%>
                <div align="center"> <font face="Arial, Helvetica, sans-serif" color="#FF0000">  
                  <input type="checkbox" <% if whatnew=1 then %> checked <% end if %> name="product_id" value="<%= trim(acres("id")&"") %>" > 
                  </font></div> 
              </td> 
...
function showpageno(pageno)  
	if recount>10 then  
		...
		if pageno>10 then  
		     response.write "<a href='sa_whatnew.asp?pageno=1&pname="&pname&"'> The First Page </a>&nbsp;&nbsp;"  
			response.write "<a href='sa_whatnew.asp?pageno="&(pageno-9-(pageno  mod 10) )&"&pname="&pname&"'>Previous 10</a>&nbsp;&nbsp;"  
		end if  
		strtemp=pageno  
	 ...
	 for i=(strtemp-(strtemp mod 10)+1) to (strtemp+10-(strtemp mod 10))  
            ...
            if i- pageno=0 then  
				...
				response.write "<a href='sa_whatnew.asp?Pageno="&i&"&pname="&pname&"'>  "&cstr(i)&" </a>&nbsp;&nbsp;"  
			end if	  
		next  
		if (pageno\10)<(lastpage\10) then  
		        response.write "<a href='sa_whatnew.asp?Pageno="&(pageno+11-(pageno mod 10))&"&pname="&pname&"'>Next 10</a>&nbsp;&nbsp;"  
			   response.write "<a href='sa_whatnew.asp?Pageno="& (lastpage) &"&pname="&pname&"'> The Last Page</a>&nbsp;&nbsp;"  
		end if  
