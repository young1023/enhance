...
<%	acres.movenext
    ...
    <tr bgcolor="#FFFFFF" bordercolor="#CCCCCC"> 
      ...
      <td width="52%"> <font face="Verdana,Geneva,Arial,Helvetica,sans-serif">
        <input type="hidden" name="cmdsend" value="">
        </font></td>
      <td width="52%"> <font face="Verdana,Geneva,Arial,Helvetica,sans-serif"> 
        </font></td>
...
function showpageno(pageno)
	if recount>10 then
		...
		if pageno>10 then
		     response.write "<a href='eselect member.asp?pageno=1&strorder="&strorderpage&"'> The First Page</a>&nbsp;&nbsp;"
			response.write "<a href='eselect member.asp?pageno="&(pageno-9-(pageno  mod 10) )&"&strorder="&strorderpage&"'>Previous 10</a>&nbsp;&nbsp;"
		end if
		strtemp=pageno
	 ...
	 for i=(strtemp-(strtemp mod 10)+1) to (strtemp+10-(strtemp mod 10))
            ...
            if i- pageno=0 then
				...
				response.write "<a href='eselect member.asp?Pageno="&i&"&strorder="&strorderpage&"'>  "&cstr(i)&" </a>&nbsp;&nbsp;"
			end if	
		next
		if (pageno\10)<(lastpage\10) then
		        response.write "<a href='eselect member.asp?Pageno="&(pageno+11-(pageno mod 10)) &"&strorder="&strorderpage&"'>Next 10</a>&nbsp;&nbsp;"
			   response.write "<a href='eselect member.asp?Pageno="& (lastpage) &"&strorder="&strorderpage&"'> The Last Page</a>&nbsp;&nbsp;"
		end if
